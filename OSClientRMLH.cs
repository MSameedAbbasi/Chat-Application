...
namespace XQ_Client
{
    ...
    public class OSClientRMLH
    {
        ...
        {
            logger = new Logger();
            logger.LogFileName = Logger.GLOBALLOGFILENAME;

            mlogger = new Logger();
            mlogger.LogFileName = "SHMessageLog";
        ...
        private void Connect()
        {
            ...
            catch (Exception ex)
            {
                ...
                {
                    logger.Log("HISTORY_BLOTTER: Connect Catch: " + ex.ToString());
                }
            }
        }
        ...
        private void DataReceiver()
        {
            try
            {
                ...
                while (true)
                {
                    ...
                    if (iRx == 0)
                    {
                        ...
                        if (historyBlotterLoggingInstance != null && historyBlotterLoggingInstance.Text == "History Blotter")
                        {
                            logger.Log("HISTORY_BLOTTER: DataReceiver: ");
                        }
                        return;
                    }
                        ...
                        textBuffer[textBuffer.Length - 1] == '\n')
                    {
                        ...
                        catch (Exception ex)
                        {
                            ...
                            if (historyBlotterLoggingInstance != null && historyBlotterLoggingInstance.Text == "History Blotter")
                            {
                                logger.Log("HISTORY_BLOTTER: DataReceiver Inner Catch: " + ex.ToString());
                            }
                            return;
                        }
                        textBuffer = new StringBuilder();
            ...
            catch (Exception ex)
            {
                ...
                if (historyBlotterLoggingInstance != null && historyBlotterLoggingInstance.Text == "History Blotter")
                {
                    logger.Log("HISTORY_BLOTTER: DataReceiver Outer Catch: " + ex.ToString());
                }
            }
        }
        ...
        public bool write(String message)
        {
            lock (this)
            {
                ...
                catch (Exception e)
                {
                    ...
                    if (historyBlotterLoggingInstance != null && historyBlotterLoggingInstance.Text == "History Blotter")
                    {
                        logger.Log("HISTORY_BLOTTER: write Catch: " + e.ToString());
                    }
                }
                return retVal;
            }
        ...
        public bool writeWithEscapeSequence(String message)
        {
            ...
            catch (Exception e)
            {
                ...
                if (historyBlotterLoggingInstance != null && historyBlotterLoggingInstance.Text == "History Blotter")
                {
                    logger.Log("HISTORY_BLOTTER: writeWithEscapeSequence Catch: " + e.ToString());
                }
            }
        ...
        public bool WriteMany(String message)
        {
            ...
            catch (Exception e)
            {
                ...
                if (historyBlotterLoggingInstance != null && historyBlotterLoggingInstance.Text == "History Blotter")
                {
                    logger.Log("HISTORY_BLOTTER: WriteMany Catch: " + e.ToString());
                }
            }
            return retVal;
